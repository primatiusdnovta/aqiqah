...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="?module=beranda" class="logo">
      ...
      <span class="logo-mini"><b>A</b>QH</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Aqiqah</b></span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; Herry Prasetyo <?php echo date('Y'); ?> <a href="#">www.herryprasetyo.com</a>.</strong> All rights
    reserved.
  </footer>
